...
4. If no XML file is present, manually enter the numeric EPSG code (e.g. *4326* for WGS 84 Lat/Long), then cick on the OK button.   
5. Layers loaded with this tool are ony stored in virtual memory, so you will need to save them to file if you want a presistant copy. 
